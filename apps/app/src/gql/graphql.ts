...
export type ConnectRepository_MeQuery = { __typename?: 'Query', me?: { __typename?: 'User', id: string, linkedToGithub: boolean, ghInstallations: { __typename?: 'GhApiInstallationConnection', edges: Array<(
