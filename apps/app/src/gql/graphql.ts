...
export type AccountSettings_AccountQuery = { __typename?: 'Query', account?: (
    ...
    & { ' $fragmentRefs'?: { 'TeamMembers_TeamFragment': TeamMembers_TeamFragment;'TeamChangeName_TeamFragment': TeamChangeName_TeamFragment } }
