...
export type ProjectGitRepository_ProjectFragment = { __typename?: 'Project', id: string, ghRepository?: { __typename?: 'GithubRepository', id: string, fullName: string, url: string } | null } & { ' $fragmentName'?: 'ProjectGitRepository_ProjectFragment' };
