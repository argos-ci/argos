  ...
  return (
    <RACListBoxItem
      className={clsx(
        className,
        "group/item",
        "text-default data-focused:bg-active data-pressed:bg-active data-disabled:opacity-disabled text-menu flex items-center gap-2 rounded-lg px-2.5 py-1.5 select-none focus:outline-hidden",
      )}
      {...restProps}
    >
