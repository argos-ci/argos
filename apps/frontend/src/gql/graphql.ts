...
export type BuildDiffState_BuildFragment = { __typename?: 'Build', id: string, stats: { __typename?: 'BuildStats', total: number, failure: number, changed: number, added: number, removed: number, unchanged: number } } & { ' $fragmentName'?: 'BuildDiffState_BuildFragment' };
...
export type BuildHeader_BuildFragment = (
  { __typename?: 'Build', name: string, status: BuildStatus, type?: BuildType | null, pullRequest?: (
