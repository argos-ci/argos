...
export type BuildStatusDescription_BuildFragment = { __typename?: 'Build', type?: BuildType | null, status: BuildStatus, mode: BuildMode, stats: { __typename?: 'BuildStats', total: number }, parallel?: { __typename?: 'BuildParallel', total: number, received: number, nonce: string } | null } & { ' $fragmentName'?: 'BuildStatusDescription_BuildFragment' };

export type BuildStatusDescription_ProjectFragment = { __typename?: 'Project', referenceBranchGlob: string } & { ' $fragmentName'?: 'BuildStatusDescription_ProjectFragment' };
...
export type ProjectReferenceBranch_UpdateProjectMutation = { __typename?: 'Mutation', updateProject: { __typename?: 'Project', id: string, customDefaultBaseBranch?: string | null, customReferenceBranchGlob?: string | null } };

export type ProjectReferenceBranch_ProjectFragment = { __typename?: 'Project', id: string, customDefaultBaseBranch?: string | null, customReferenceBranchGlob?: string | null, repository?: { __typename: 'GithubRepository', id: string, defaultBranch: string } | { __typename: 'GitlabProject', id: string, defaultBranch: string } | null } & { ' $fragmentName'?: 'ProjectReferenceBranch_ProjectFragment' };
...
export type BuildWorkspace_BuildFragment = (
  { __typename?: 'Build', status: BuildStatus, type?: BuildType | null, mode: BuildMode, stats: { __typename?: 'BuildStats', total: number, failure: number, changed: number, added: number, removed: number, unchanged: number }, parallel?: { __typename?: 'BuildParallel', total: number, received: number, nonce: string } | null }
...
export type BuildWorkspace_ProjectFragment = (
  { __typename?: 'Project', referenceBranchGlob: string, slug: string, repository?: { __typename?: 'GithubRepository', id: string, url: string } | { __typename?: 'GitlabProject', id: string, url: string } | null }
  & { ' $fragmentRefs'?: { 'BuildStatusDescription_ProjectFragment': BuildStatusDescription_ProjectFragment } }
...
export type BuildHeader_ProjectFragment = (
  { __typename?: 'Project' }
  & { ' $fragmentRefs'?: { 'BuildStatusChip_ProjectFragment': BuildStatusChip_ProjectFragment;'BuildReviewButton_ProjectFragment': BuildReviewButton_ProjectFragment } }
...
export const BuildHeader_ProjectFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"BuildHeader_Project"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Project"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"BuildStatusChip_Project"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"BuildReviewButton_Project"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"BuildStatusDescription_Project"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Project"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"referenceBranchGlob"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"BuildStatusChip_Project"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Project"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"BuildStatusDescription_Project"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"BuildReviewButton_Project"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Project"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"permissions"}},{"kind":"Field","name":{"kind":"Name","value":"public"}},{"kind":"Field","name":{"kind":"Name","value":"account"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}}]}},{"kind":"Field","name":{"kind":"Name","value":"build"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"number"},"value":{"kind":"Variable","name":{"kind":"Name","value":"buildNumber"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]}}]} as unknown as DocumentNode<BuildHeader_ProjectFragment, unknown>;
...
export const ProjectReferenceBranch_UpdateProjectDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ProjectReferenceBranch_updateProject"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"defaultBaseBranch"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"referenceBranchGlob"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateProject"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"defaultBaseBranch"},"value":{"kind":"Variable","name":{"kind":"Name","value":"defaultBaseBranch"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"referenceBranchGlob"},"value":{"kind":"Variable","name":{"kind":"Name","value":"referenceBranchGlob"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"customDefaultBaseBranch"}},{"kind":"Field","name":{"kind":"Name","value":"customReferenceBranchGlob"}}]}}]}}]} as unknown as DocumentNode<ProjectReferenceBranch_UpdateProjectMutation, ProjectReferenceBranch_UpdateProjectMutationVariables>;
