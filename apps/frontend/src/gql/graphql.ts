...
export type BuildHeader_BuildFragment = (
  { __typename?: 'Build', name: string, status: BuildStatus, prNumber?: number | null }
...
export type ProjectBuilds_ProjectQuery = { __typename?: 'Query', project?: (
    { __typename?: 'Project', id: string, permissions: Array<Permission>, repository?: { __typename?: 'GithubRepository', id: string, url: string } | { __typename?: 'GitlabProject', id: string, url: string } | null }
