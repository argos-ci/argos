...
export type BuildDiffState_BuildFragment = { __typename?: 'Build', id: string, stats: { __typename?: 'BuildStats', total: number, failure: number, changed: number, added: number, removed: number, unchanged: number, retryFailure: number } } & { ' $fragmentName'?: 'BuildDiffState_BuildFragment' };
