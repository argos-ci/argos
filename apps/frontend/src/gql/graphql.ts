...
export type BuildDiffState_BuildFragment = { __typename?: 'Build', id: string, stats: { __typename?: 'BuildStats', total: number, failure: number, changed: number, added: number, removed: number, unchanged: number, retriedFailure: number } } & { ' $fragmentName'?: 'BuildDiffState_BuildFragment' };

export type BuildInfos_BuildFragment = { __typename?: 'Build', createdAt: any, name: string, commit: string, branch: string, mode: BuildMode, stats: { __typename?: 'BuildStats', total: number }, baseScreenshotBucket?: { __typename?: 'ScreenshotBucket', commit: string, branch: string } | null, pullRequest?: { __typename?: 'GithubPullRequest', id: string, url: string, number: number } | null } & { ' $fragmentName'?: 'BuildInfos_BuildFragment' };
...
export type ProjectBuilds_Project_BuildsQuery = { __typename?: 'Query', project?: { __typename?: 'Project', id: string, builds: { __typename?: 'BuildConnection', pageInfo: { __typename?: 'PageInfo', totalCount: number, hasNextPage: boolean }, edges: Array<(
        { __typename?: 'Build', id: string, number: number, createdAt: any, name: string, branch: string, commit: string, mode: BuildMode, pullRequest?: (
          { __typename?: 'GithubPullRequest', id: string }
          & { ' $fragmentRefs'?: { 'PullRequestButton_PullRequestFragment': PullRequestButton_PullRequestFragment } }
        ) | null }
        & { ' $fragmentRefs'?: { 'BuildStatusChip_BuildFragment': BuildStatusChip_BuildFragment } }
