...
--
-- Name: user_sessions user_sessions_tokenhash_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: user_sessions_active_user; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX user_sessions_active_user ON public.user_sessions USING btree ("userId") WHERE ("revokedAt" IS NULL);
...
--
-- Name: deployments deployments_githubpullrequestid_foreign; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.deployments
    ADD CONSTRAINT deployments_githubpullrequestid_foreign FOREIGN KEY ("githubPullRequestId") REFERENCES public.github_pull_requests(id);


--
-- Name: deployments deployments_projectid_foreign; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.deployments
    ADD CONSTRAINT deployments_projectid_foreign FOREIGN KEY ("projectId") REFERENCES public.projects(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.user_sessions
    ADD CONSTRAINT user_sessions_userid_foreign FOREIGN KEY ("userId") REFERENCES public.users(id) ON DELETE CASCADE;
