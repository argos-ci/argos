...
--
CREATE TYPE public.service_type AS ENUM ('github');
...
--
CREATE TYPE public.synchronization_type AS ENUM ('user', 'installation');
...
--
CREATE SEQUENCE public.accounts_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.audit_trails OWNER TO postgres;
...
--
CREATE SEQUENCE public.audit_trails_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE public.automation_action_runs (
    ...
    CONSTRAINT automation_action_runs_conclusion_requires_completed_status CHECK (
        (
            (conclusion IS NULL)
            OR (("jobStatus") :: text = 'complete' :: text)
        )
    )
);

ALTER TABLE
    public.automation_action_runs OWNER TO postgres;

--
-- Name: automation_action_runs_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.automation_action_runs_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.automation_rules OWNER TO postgres;

--
-- Name: automation_rules_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.automation_rules_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.automation_runs OWNER TO postgres;

--
-- Name: automation_runs_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.automation_runs_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.build_merge_queue_gh_pull_requests OWNER TO postgres;

--
-- Name: build_merge_queue_gh_pull_requests_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.build_merge_queue_gh_pull_requests_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.build_notifications OWNER TO postgres;

--
-- Name: build_notifications_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.build_notifications_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE public.build_reviews (
    ...
    "buildId" bigint NOT NULL,
    state text NOT NULL,
    CONSTRAINT build_reviews_state_check CHECK (
        (
            state = ANY (ARRAY ['approved'::text, 'rejected'::text])
        )
    )
);

ALTER TABLE
    public.build_reviews OWNER TO postgres;

--
-- Name: build_reviews_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.build_reviews_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.build_shards OWNER TO postgres;

--
-- Name: build_shards_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.build_shards_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE public.builds (
    ...
    CONSTRAINT "builds_baseBranchResolvedFrom_check" CHECK (
        (
            "baseBranchResolvedFrom" = ANY (
                ARRAY ['user'::text, 'pull-request'::text, 'project'::text]
            )
        )
    ),
    CONSTRAINT builds_conclusion_check CHECK (
        (
            conclusion = ANY (
                ARRAY ['no-changes'::text, 'changes-detected'::text]
            )
        )
    ),
    CONSTRAINT builds_mode_check CHECK (
        (
            mode = ANY (ARRAY ['ci'::text, 'monitoring'::text])
        )
    ),
    CONSTRAINT builds_type_check CHECK (
        (
            type = ANY (
                ARRAY ['reference'::text, 'check'::text, 'orphan'::text, 'skipped'::text]
            )
        )
    )
);
...
ALTER TABLE
    public.builds OWNER TO postgres;

--
-- Name: builds_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.builds_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE public.files (
    ...
    CONSTRAINT files_type_check CHECK (
        (
            type = ANY (
                ARRAY ['screenshot'::text, 'screenshotDiff'::text, 'playwrightTrace'::text]
            )
        )
    )
);
...
ALTER TABLE
    public.files OWNER TO postgres;

--
-- Name: files_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.files_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.github_account_members OWNER TO postgres;

--
-- Name: github_account_members_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.github_account_members_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE public.github_accounts (
    ...
    emails jsonb,
    CONSTRAINT github_accounts_type_check CHECK (
        (
            type = ANY (
                ARRAY ['user'::text, 'organization'::text, 'bot'::text]
            )
        )
    )
);
...
ALTER TABLE
    public.github_accounts OWNER TO postgres;

--
-- Name: github_accounts_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.github_accounts_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.github_installations OWNER TO postgres;

--
-- Name: github_installations_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.github_installations_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.github_pull_requests OWNER TO postgres;

--
-- Name: github_pull_requests_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.github_pull_requests_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.github_repositories OWNER TO postgres;

--
-- Name: github_repositories_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.github_repositories_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.github_repository_installations OWNER TO postgres;

--
-- Name: github_repository_installations_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.github_repository_installations_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.github_synchronizations OWNER TO postgres;

--
-- Name: github_synchronizations_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.github_synchronizations_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE public.gitlab_projects (
    ...
    CONSTRAINT gitlab_projects_visibility_check CHECK (
        (
            visibility = ANY (
                ARRAY ['public'::text, 'internal'::text, 'private'::text]
            )
        )
    )
);
...
ALTER TABLE
    public.gitlab_projects OWNER TO postgres;

--
-- Name: gitlab_projects_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.gitlab_projects_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.gitlab_users OWNER TO postgres;

--
-- Name: gitlab_users_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.gitlab_users_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.google_users OWNER TO postgres;

--
-- Name: google_users_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.google_users_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.ignored_changes OWNER TO postgres;
...
ALTER TABLE
    public.knex_migrations OWNER TO postgres;
...
ALTER TABLE
    public.knex_migrations_lock OWNER TO postgres;
...
ALTER TABLE
    public.notification_messages OWNER TO postgres;

--
-- Name: notification_messages_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.notification_messages_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.notification_workflow_recipients OWNER TO postgres;

--
-- Name: notification_workflow_recipients_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.notification_workflow_recipients_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.notification_workflows OWNER TO postgres;

--
-- Name: notification_workflows_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.notification_workflows_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE public.plans (
    ...
    CONSTRAINT plans_interval_check CHECK (
        (
            "interval" = ANY (ARRAY ['month'::text, 'year'::text])
        )
    )
);

ALTER TABLE
    public.plans OWNER TO postgres;

--
-- Name: plans_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.plans_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE public.project_users (
    ...
    CONSTRAINT "project_users_userLevel_check" CHECK (
        (
            "userLevel" = ANY (
                ARRAY ['admin'::text, 'reviewer'::text, 'viewer'::text]
            )
        )
    )
);
...
ALTER TABLE
    public.project_users OWNER TO postgres;

--
-- Name: project_users_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.project_users_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE public.projects (
    ...
    "autoIgnore" jsonb,
    CONSTRAINT "projects_defaultUserLevel_check" CHECK (
        (
            "defaultUserLevel" = ANY (
                ARRAY ['admin'::text, 'reviewer'::text, 'viewer'::text]
            )
        )
    ),
    CONSTRAINT "projects_summaryCheck_check" CHECK (
        (
            "summaryCheck" = ANY (
                ARRAY ['always'::text, 'auto'::text, 'never'::text]
            )
        )
    )
);
...
CREATE TABLE public.screenshot_buckets (
    ...
    CONSTRAINT chk_complete_true_screenshotcount_not_null CHECK (
        (
            (complete = false)
            OR ("screenshotCount" IS NOT NULL)
        )
    ),
    CONSTRAINT chk_complete_true_storybookscreenshotcount_not_null CHECK (
        (
            (complete = false)
            OR ("storybookScreenshotCount" IS NOT NULL)
        )
    ),
    CONSTRAINT screenshot_buckets_mode_check CHECK (
        (
            mode = ANY (ARRAY ['ci'::text, 'monitoring'::text])
        )
    )
...
ALTER TABLE
    public.screenshot_buckets OWNER TO postgres;

--
-- Name: screenshot_buckets_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.screenshot_buckets_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE public.screenshot_diff_reviews (
    ...
    state text NOT NULL,
    CONSTRAINT screenshot_diff_reviews_state_check CHECK (
        (
            state = ANY (ARRAY ['approved'::text, 'rejected'::text])
        )
    )
...
ALTER TABLE
    public.screenshot_diff_reviews OWNER TO postgres;
...
ALTER TABLE
    public.screenshot_diffs OWNER TO postgres;

--
-- Name: screenshot_diffs_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.screenshot_diffs_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.screenshots OWNER TO postgres;

--
-- Name: screenshots_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.screenshots_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.slack_channels OWNER TO postgres;

--
-- Name: slack_channels_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.slack_channels_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.slack_installations OWNER TO postgres;

--
-- Name: slack_installations_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.slack_installations_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE public.subscriptions (
    ...
    CONSTRAINT check_stripe_fields CHECK (
        (
            (provider <> 'stripe' :: text)
            OR (
    ...
    CONSTRAINT subscriptions_provider_check CHECK (
        (
            provider = ANY (ARRAY ['stripe'::text, 'github'::text])
        )
    )
);
...
CREATE TABLE public.team_invites (
    ...
    CONSTRAINT "team_invites_userLevel_check" CHECK (
        (
            "userLevel" = ANY (
                ARRAY ['owner'::text, 'member'::text, 'contributor'::text]
            )
        )
    )
);
...
ALTER TABLE
    public.team_invites OWNER TO postgres;
...
CREATE TABLE public.team_saml_configs (
    ...
    CONSTRAINT team_saml_configs_enforced_requires_enforcedat CHECK (
        (
            (
                enforced
...
ALTER TABLE
    public.team_saml_configs OWNER TO postgres;

--
-- Name: team_saml_configs_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.team_saml_configs_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE public.team_users (
    ...
    "lastAuthMethod" text,
    CONSTRAINT "team_users_lastAuthMethod_check" CHECK (
        (
            "lastAuthMethod" = ANY (
                ARRAY ['email'::text, 'google'::text, 'github'::text, 'gitlab'::text, 'saml'::text]
            )
        )
    ),
    CONSTRAINT "team_users_userLevel_check" CHECK (
        (
            "userLevel" = ANY (
                ARRAY ['owner'::text, 'member'::text, 'contributor'::text]
            )
...
ALTER TABLE
    public.team_users OWNER TO postgres;

--
-- Name: team_users_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.team_users_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE public.teams (
    ...
    CONSTRAINT "teams_defaultUserLevel_check" CHECK (
        (
            "defaultUserLevel" = ANY (ARRAY ['member'::text, 'contributor'::text])
        )
    )
);
...
ALTER TABLE
    public.test_stats_builds OWNER TO postgres;
...
ALTER TABLE
    public.test_stats_fingerprints OWNER TO postgres;
...
ALTER TABLE
    public.tests OWNER TO postgres;

--
-- Name: tests_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.tests_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.user_access_token_scopes OWNER TO postgres;

--
-- Name: user_access_token_scopes_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.user_access_token_scopes_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE public.user_access_tokens (
    ...
    CONSTRAINT user_access_tokens_source_check CHECK (
        (source = ANY (ARRAY ['user'::text, 'cli'::text]))
    )
);

ALTER TABLE
    public.user_access_tokens OWNER TO postgres;

--
-- Name: user_access_tokens_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
CREATE SEQUENCE public.user_access_tokens_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE
    public.user_emails OWNER TO postgres;
...
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.accounts_id_seq' :: regclass);

--
-- Name: audit_trails id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.audit_trails
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.audit_trails_id_seq' :: regclass);

--
-- Name: automation_action_runs id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.automation_action_runs
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.automation_action_runs_id_seq' :: regclass);

--
-- Name: automation_rules id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.automation_rules
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.automation_rules_id_seq' :: regclass);

--
-- Name: automation_runs id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.automation_runs
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.automation_runs_id_seq' :: regclass);

--
-- Name: build_merge_queue_gh_pull_requests id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.build_merge_queue_gh_pull_requests
ALTER COLUMN
    id
SET
    DEFAULT nextval(
        'public.build_merge_queue_gh_pull_requests_id_seq' :: regclass
    );
...
--
ALTER TABLE
    ONLY public.build_notifications
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.build_notifications_id_seq' :: regclass);

--
-- Name: build_reviews id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.build_reviews
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.build_reviews_id_seq' :: regclass);

--
-- Name: build_shards id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.build_shards
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.build_shards_id_seq' :: regclass);
...
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.builds_id_seq' :: regclass);
...
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.files_id_seq' :: regclass);

--
-- Name: github_account_members id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.github_account_members
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.github_account_members_id_seq' :: regclass);

--
-- Name: github_accounts id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.github_accounts
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.github_accounts_id_seq' :: regclass);

--
-- Name: github_installations id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.github_installations
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.github_installations_id_seq' :: regclass);

--
-- Name: github_pull_requests id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.github_pull_requests
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.github_pull_requests_id_seq' :: regclass);

--
-- Name: github_repositories id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.github_repositories
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.github_repositories_id_seq' :: regclass);

--
-- Name: github_repository_installations id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.github_repository_installations
ALTER COLUMN
    id
SET
    DEFAULT nextval(
        'public.github_repository_installations_id_seq' :: regclass
    );
...
--
ALTER TABLE
    ONLY public.github_synchronizations
ALTER COLUMN
    id
SET
    DEFAULT nextval(
        'public.github_synchronizations_id_seq' :: regclass
    );
...
--
ALTER TABLE
    ONLY public.gitlab_projects
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.gitlab_projects_id_seq' :: regclass);

--
-- Name: gitlab_users id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.gitlab_users
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.gitlab_users_id_seq' :: regclass);

--
-- Name: google_users id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.google_users
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.google_users_id_seq' :: regclass);
...
--
ALTER TABLE
    ONLY public.notification_messages
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.notification_messages_id_seq' :: regclass);

--
-- Name: notification_workflow_recipients id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.notification_workflow_recipients
ALTER COLUMN
    id
SET
    DEFAULT nextval(
        'public.notification_workflow_recipients_id_seq' :: regclass
    );
...
--
ALTER TABLE
    ONLY public.notification_workflows
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.notification_workflows_id_seq' :: regclass);
...
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.plans_id_seq' :: regclass);

--
-- Name: project_users id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.project_users
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.project_users_id_seq' :: regclass);
...
--
ALTER TABLE
    ONLY public.screenshot_buckets
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.screenshot_buckets_id_seq' :: regclass);

--
-- Name: screenshot_diffs id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.screenshot_diffs
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.screenshot_diffs_id_seq' :: regclass);

--
-- Name: screenshots id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.screenshots
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.screenshots_id_seq' :: regclass);

--
-- Name: slack_channels id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.slack_channels
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.slack_channels_id_seq' :: regclass);

--
-- Name: slack_installations id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.slack_installations
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.slack_installations_id_seq' :: regclass);
...
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.subscriptions_id_seq' :: regclass);

--
-- Name: team_saml_configs id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.team_saml_configs
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.team_saml_configs_id_seq' :: regclass);

--
-- Name: team_users id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.team_users
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.team_users_id_seq' :: regclass);
...
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.teams_id_seq' :: regclass);
...
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.tests_id_seq' :: regclass);

--
-- Name: user_access_token_scopes id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.user_access_token_scopes
ALTER COLUMN
    id
SET
    DEFAULT nextval(
        'public.user_access_token_scopes_id_seq' :: regclass
    );
...
--
ALTER TABLE
    ONLY public.user_access_tokens
ALTER COLUMN
    id
SET
    DEFAULT nextval('public.user_access_tokens_id_seq' :: regclass);
...
ALTER TABLE
    ONLY public.accounts
ADD
    CONSTRAINT accounts_githubaccountid_unique UNIQUE ("githubAccountId");
...
ALTER TABLE
    ONLY public.accounts
ADD
    CONSTRAINT accounts_slackinstallationid_unique UNIQUE ("slackInstallationId");
...
ALTER TABLE
    ONLY public.build_merge_queue_gh_pull_requests
ADD
    CONSTRAINT build_merge_queue_gh_pull_requests_buildid_githubpullrequestid_ UNIQUE ("buildId", "githubPullRequestId");
...
ALTER TABLE
    ONLY public.build_merge_queue_gh_pull_requests
ADD
    CONSTRAINT build_merge_queue_gh_pull_requests_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.build_notifications
ADD
    CONSTRAINT build_notifications_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.build_shards
ADD
    CONSTRAINT build_shards_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.github_account_members
ADD
    CONSTRAINT github_account_members_githubaccountid_githubmemberid_unique UNIQUE ("githubAccountId", "githubMemberId");
...
ALTER TABLE
    ONLY public.github_account_members
ADD
    CONSTRAINT github_account_members_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.github_accounts
ADD
    CONSTRAINT github_accounts_githubid_unique UNIQUE ("githubId");
...
ALTER TABLE
    ONLY public.github_installations
ADD
    CONSTRAINT github_installations_githubid_unique UNIQUE ("githubId");
...
ALTER TABLE
    ONLY public.github_repositories
ADD
    CONSTRAINT github_repositories_githubid_unique UNIQUE ("githubId");
...
ALTER TABLE
    ONLY public.github_repository_installations
ADD
    CONSTRAINT github_repository_installations_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.github_synchronizations
ADD
    CONSTRAINT github_synchronizations_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.google_users
ADD
    CONSTRAINT google_users_googleid_unique UNIQUE ("googleId");
...
--
ALTER TABLE
    ONLY public.ignored_changes
ADD
    CONSTRAINT ignored_changes_pkey PRIMARY KEY ("projectId", "testId", fingerprint);
...
ALTER TABLE
    ONLY public.notification_workflow_recipients
ADD
    CONSTRAINT notification_workflow_recipients_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.project_users
ADD
    CONSTRAINT project_users_userid_projectid_unique UNIQUE ("userId", "projectId");
...
ALTER TABLE
    ONLY public.screenshot_buckets
ADD
    CONSTRAINT screenshot_buckets_pkey PRIMARY KEY (id);

--
-- Name: screenshot_diff_reviews screenshot_diff_reviews_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.screenshot_diff_reviews
ADD
    CONSTRAINT screenshot_diff_reviews_pkey PRIMARY KEY ("buildReviewId", "screenshotDiffId");
...
ALTER TABLE
    ONLY public.screenshot_diffs
ADD
    CONSTRAINT screenshot_diffs_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.slack_installations
ADD
    CONSTRAINT slack_installations_teamdomain_unique UNIQUE ("teamDomain");
...
--
ALTER TABLE
    ONLY public.team_invites
ADD
    CONSTRAINT team_invites_pkey PRIMARY KEY (email, "teamId");
...
ALTER TABLE
    ONLY public.team_invites
ADD
    CONSTRAINT team_invites_secret_unique UNIQUE (secret);
...
ALTER TABLE
    ONLY public.team_saml_configs
ADD
    CONSTRAINT team_saml_configs_accountid_unique UNIQUE ("accountId");
...
ALTER TABLE
    ONLY public.team_saml_configs
ADD
    CONSTRAINT team_saml_configs_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.team_users
ADD
    CONSTRAINT team_users_teamid_userid_unique UNIQUE ("teamId", "userId");
...
--
ALTER TABLE
    ONLY public.test_stats_builds
ADD
    CONSTRAINT test_stats_builds_pkey PRIMARY KEY ("testId", date);

--
-- Name: test_stats_fingerprints test_stats_fingerprints_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
ALTER TABLE
    ONLY public.test_stats_fingerprints
ADD
    CONSTRAINT test_stats_fingerprints_pkey PRIMARY KEY ("testId", fingerprint, date);
...
ALTER TABLE
    ONLY public.user_access_token_scopes
ADD
    CONSTRAINT user_access_token_scopes_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.user_access_token_scopes
ADD
    CONSTRAINT user_access_token_scopes_useraccesstokenid_accountid_unique UNIQUE ("userAccessTokenId", "accountId");
...
--
CREATE INDEX screenshot_diffs_buildid_notnull_include_testid_idx ON public.screenshot_diffs USING btree ("buildId") INCLUDE ("testId")
WHERE
    ("testId" IS NOT NULL);
...
--
CREATE INDEX screenshot_diffs_testid_createdat_desc_cmp_notnull_idx ON public.screenshot_diffs USING btree ("testId", "createdAt" DESC) INCLUDE ("compareScreenshotId")
WHERE
    ("compareScreenshotId" IS NOT NULL);
...
--
CREATE INDEX tests_projectid_buildname_createdat_id_idx ON public.tests USING btree (
    "projectId",
    "buildName",
    "createdAt" DESC,
    id DESC
...
ALTER TABLE
    ONLY public.accounts
ADD
    CONSTRAINT accounts_forcedplanid_foreign FOREIGN KEY ("forcedPlanId") REFERENCES public.plans(id);
...
ALTER TABLE
    ONLY public.accounts
ADD
    CONSTRAINT accounts_githubaccountid_foreign FOREIGN KEY ("githubAccountId") REFERENCES public.github_accounts(id);
...
ALTER TABLE
    ONLY public.accounts
ADD
    CONSTRAINT accounts_githublightinstallationid_foreign FOREIGN KEY ("githubLightInstallationId") REFERENCES public.github_installations(id);
...
ALTER TABLE
    ONLY public.accounts
ADD
    CONSTRAINT accounts_slackinstallationid_foreign FOREIGN KEY ("slackInstallationId") REFERENCES public.slack_installations(id);
...
ALTER TABLE
    ONLY public.accounts
ADD
    CONSTRAINT accounts_teamid_foreign FOREIGN KEY ("teamId") REFERENCES public.teams(id);
...
ALTER TABLE
    ONLY public.accounts
ADD
    CONSTRAINT accounts_userid_foreign FOREIGN KEY ("userId") REFERENCES public.users(id);
...
ALTER TABLE
    ONLY public.audit_trails
ADD
    CONSTRAINT audit_trails_projectid_foreign FOREIGN KEY ("projectId") REFERENCES public.projects(id);
...
ALTER TABLE
    ONLY public.audit_trails
ADD
    CONSTRAINT audit_trails_testid_foreign FOREIGN KEY ("testId") REFERENCES public.tests(id);
...
ALTER TABLE
    ONLY public.audit_trails
ADD
    CONSTRAINT audit_trails_userid_foreign FOREIGN KEY ("userId") REFERENCES public.users(id);
...
ALTER TABLE
    ONLY public.automation_action_runs
ADD
    CONSTRAINT automation_action_runs_automationrunid_foreign FOREIGN KEY ("automationRunId") REFERENCES public.automation_runs(id);
...
ALTER TABLE
    ONLY public.automation_rules
ADD
    CONSTRAINT automation_rules_projectid_foreign FOREIGN KEY ("projectId") REFERENCES public.projects(id);
...
ALTER TABLE
    ONLY public.automation_runs
ADD
    CONSTRAINT automation_runs_automationruleid_foreign FOREIGN KEY ("automationRuleId") REFERENCES public.automation_rules(id);
...
ALTER TABLE
    ONLY public.automation_runs
ADD
    CONSTRAINT automation_runs_buildid_foreign FOREIGN KEY ("buildId") REFERENCES public.builds(id);
...
ALTER TABLE
    ONLY public.automation_runs
ADD
    CONSTRAINT automation_runs_buildreviewid_foreign FOREIGN KEY ("buildReviewId") REFERENCES public.build_reviews(id);
...
ALTER TABLE
    ONLY public.build_merge_queue_gh_pull_requests
ADD
    CONSTRAINT build_merge_queue_gh_pull_requests_buildid_foreign FOREIGN KEY ("buildId") REFERENCES public.builds(id) ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.build_merge_queue_gh_pull_requests
ADD
    CONSTRAINT build_merge_queue_gh_pull_requests_githubpullrequestid_foreign FOREIGN KEY ("githubPullRequestId") REFERENCES public.github_pull_requests(id) ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.build_notifications
ADD
    CONSTRAINT build_notifications_buildid_foreign FOREIGN KEY ("buildId") REFERENCES public.builds(id);
...
ALTER TABLE
    ONLY public.build_reviews
ADD
    CONSTRAINT build_reviews_buildid_foreign FOREIGN KEY ("buildId") REFERENCES public.builds(id);
...
ALTER TABLE
    ONLY public.build_reviews
ADD
    CONSTRAINT build_reviews_userid_foreign FOREIGN KEY ("userId") REFERENCES public.users(id);
...
ALTER TABLE
    ONLY public.build_shards
ADD
    CONSTRAINT build_shards_buildid_foreign FOREIGN KEY ("buildId") REFERENCES public.builds(id);
...
ALTER TABLE
    ONLY public.builds
ADD
    CONSTRAINT builds_basescreenshotbucketid_foreign FOREIGN KEY ("baseScreenshotBucketId") REFERENCES public.screenshot_buckets(id);
...
ALTER TABLE
    ONLY public.builds
ADD
    CONSTRAINT builds_comparescreenshotbucketid_foreign FOREIGN KEY ("compareScreenshotBucketId") REFERENCES public.screenshot_buckets(id);
...
ALTER TABLE
    ONLY public.builds
ADD
    CONSTRAINT builds_githubpullrequestid_foreign FOREIGN KEY ("githubPullRequestId") REFERENCES public.github_pull_requests(id);
...
ALTER TABLE
    ONLY public.builds
ADD
    CONSTRAINT builds_projectid_foreign FOREIGN KEY ("projectId") REFERENCES public.projects(id);
...
ALTER TABLE
    ONLY public.github_account_members
ADD
    CONSTRAINT github_account_members_githubaccountid_foreign FOREIGN KEY ("githubAccountId") REFERENCES public.github_accounts(id);
...
ALTER TABLE
    ONLY public.github_account_members
ADD
    CONSTRAINT github_account_members_githubmemberid_foreign FOREIGN KEY ("githubMemberId") REFERENCES public.github_accounts(id);
...
ALTER TABLE
    ONLY public.github_pull_requests
ADD
    CONSTRAINT github_pull_requests_creatorid_foreign FOREIGN KEY ("creatorId") REFERENCES public.github_accounts(id);
...
ALTER TABLE
    ONLY public.github_pull_requests
ADD
    CONSTRAINT github_pull_requests_githubrepositoryid_foreign FOREIGN KEY ("githubRepositoryId") REFERENCES public.github_repositories(id);
...
ALTER TABLE
    ONLY public.github_repositories
ADD
    CONSTRAINT github_repositories_githubaccountid_foreign FOREIGN KEY ("githubAccountId") REFERENCES public.github_accounts(id);
...
ALTER TABLE
    ONLY public.github_repository_installations
ADD
    CONSTRAINT github_repository_installations_githubinstallationid_foreign FOREIGN KEY ("githubInstallationId") REFERENCES public.github_installations(id);
...
ALTER TABLE
    ONLY public.github_repository_installations
ADD
    CONSTRAINT github_repository_installations_githubrepositoryid_foreign FOREIGN KEY ("githubRepositoryId") REFERENCES public.github_repositories(id);
...
ALTER TABLE
    ONLY public.github_synchronizations
ADD
    CONSTRAINT github_synchronizations_githubinstallationid_foreign FOREIGN KEY ("githubInstallationId") REFERENCES public.github_installations(id);
...
ALTER TABLE
    ONLY public.ignored_changes
ADD
    CONSTRAINT ignored_changes_projectid_foreign FOREIGN KEY ("projectId") REFERENCES public.projects(id);
...
ALTER TABLE
    ONLY public.ignored_changes
ADD
    CONSTRAINT ignored_changes_testid_foreign FOREIGN KEY ("testId") REFERENCES public.tests(id);
...
ALTER TABLE
    ONLY public.notification_messages
ADD
    CONSTRAINT notification_messages_userid_foreign FOREIGN KEY ("userId") REFERENCES public.users(id);
...
ALTER TABLE
    ONLY public.notification_messages
ADD
    CONSTRAINT notification_messages_workflowid_foreign FOREIGN KEY ("workflowId") REFERENCES public.notification_workflows(id);
...
ALTER TABLE
    ONLY public.notification_workflow_recipients
ADD
    CONSTRAINT notification_workflow_recipients_userid_foreign FOREIGN KEY ("userId") REFERENCES public.users(id);
...
ALTER TABLE
    ONLY public.notification_workflow_recipients
ADD
    CONSTRAINT notification_workflow_recipients_workflowid_foreign FOREIGN KEY ("workflowId") REFERENCES public.notification_workflows(id);
...
ALTER TABLE
    ONLY public.project_users
ADD
    CONSTRAINT project_users_projectid_foreign FOREIGN KEY ("projectId") REFERENCES public.projects(id);
...
ALTER TABLE
    ONLY public.project_users
ADD
    CONSTRAINT project_users_userid_foreign FOREIGN KEY ("userId") REFERENCES public.users(id);
...
ALTER TABLE
    ONLY public.projects
ADD
    CONSTRAINT projects_accountid_foreign FOREIGN KEY ("accountId") REFERENCES public.accounts(id);
...
ALTER TABLE
    ONLY public.projects
ADD
    CONSTRAINT projects_githubrepositoryid_foreign FOREIGN KEY ("githubRepositoryId") REFERENCES public.github_repositories(id);
...
ALTER TABLE
    ONLY public.projects
ADD
    CONSTRAINT projects_gitlabprojectid_foreign FOREIGN KEY ("gitlabProjectId") REFERENCES public.gitlab_projects(id);
...
ALTER TABLE
    ONLY public.screenshot_buckets
ADD
    CONSTRAINT screenshot_buckets_projectid_foreign FOREIGN KEY ("projectId") REFERENCES public.projects(id);
...
ALTER TABLE
    ONLY public.screenshot_diff_reviews
ADD
    CONSTRAINT screenshot_diff_reviews_buildreviewid_foreign FOREIGN KEY ("buildReviewId") REFERENCES public.build_reviews(id);
...
ALTER TABLE
    ONLY public.screenshot_diff_reviews
ADD
    CONSTRAINT screenshot_diff_reviews_screenshotdiffid_foreign FOREIGN KEY ("screenshotDiffId") REFERENCES public.screenshot_diffs(id);
...
ALTER TABLE
    ONLY public.screenshot_diffs
ADD
    CONSTRAINT screenshot_diffs_basescreenshotid_foreign FOREIGN KEY ("baseScreenshotId") REFERENCES public.screenshots(id);
...
ALTER TABLE
    ONLY public.screenshot_diffs
ADD
    CONSTRAINT screenshot_diffs_buildid_foreign FOREIGN KEY ("buildId") REFERENCES public.builds(id);
...
ALTER TABLE
    ONLY public.screenshot_diffs
ADD
    CONSTRAINT screenshot_diffs_comparescreenshotid_foreign FOREIGN KEY ("compareScreenshotId") REFERENCES public.screenshots(id);
...
ALTER TABLE
    ONLY public.screenshot_diffs
ADD
    CONSTRAINT screenshot_diffs_fileid_foreign FOREIGN KEY ("fileId") REFERENCES public.files(id);
...
ALTER TABLE
    ONLY public.screenshot_diffs
ADD
    CONSTRAINT screenshot_diffs_testid_foreign FOREIGN KEY ("testId") REFERENCES public.tests(id);
...
ALTER TABLE
    ONLY public.screenshots
ADD
    CONSTRAINT screenshots_buildshardid_foreign FOREIGN KEY ("buildShardId") REFERENCES public.build_shards(id);
...
ALTER TABLE
    ONLY public.screenshots
ADD
    CONSTRAINT screenshots_fileid_foreign FOREIGN KEY ("fileId") REFERENCES public.files(id);
...
ALTER TABLE
    ONLY public.screenshots
ADD
    CONSTRAINT screenshots_playwrighttracefileid_foreign FOREIGN KEY ("playwrightTraceFileId") REFERENCES public.files(id);
...
ALTER TABLE
    ONLY public.screenshots
ADD
    CONSTRAINT screenshots_screenshotbucketid_foreign FOREIGN KEY ("screenshotBucketId") REFERENCES public.screenshot_buckets(id);
...
ALTER TABLE
    ONLY public.screenshots
ADD
    CONSTRAINT screenshots_testid_foreign FOREIGN KEY ("testId") REFERENCES public.tests(id);
...
ALTER TABLE
    ONLY public.slack_channels
ADD
    CONSTRAINT slack_channels_slackinstallationid_foreign FOREIGN KEY ("slackInstallationId") REFERENCES public.slack_installations(id);
...
ALTER TABLE
    ONLY public.subscriptions
ADD
    CONSTRAINT subscriptions_accountid_foreign FOREIGN KEY ("accountId") REFERENCES public.accounts(id);
...
ALTER TABLE
    ONLY public.subscriptions
ADD
    CONSTRAINT subscriptions_planid_foreign FOREIGN KEY ("planId") REFERENCES public.plans(id);
...
ALTER TABLE
    ONLY public.subscriptions
ADD
    CONSTRAINT subscriptions_subscriberid_foreign FOREIGN KEY ("subscriberId") REFERENCES public.users(id);
...
ALTER TABLE
    ONLY public.team_invites
ADD
    CONSTRAINT team_invites_invitedbyid_foreign FOREIGN KEY ("invitedById") REFERENCES public.users(id);
...
ALTER TABLE
    ONLY public.team_invites
ADD
    CONSTRAINT team_invites_teamid_foreign FOREIGN KEY ("teamId") REFERENCES public.teams(id);
...
ALTER TABLE
    ONLY public.team_saml_configs
ADD
    CONSTRAINT team_saml_configs_accountid_foreign FOREIGN KEY ("accountId") REFERENCES public.accounts(id) ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.team_users
ADD
    CONSTRAINT team_users_teamid_foreign FOREIGN KEY ("teamId") REFERENCES public.teams(id);
...
ALTER TABLE
    ONLY public.team_users
ADD
    CONSTRAINT team_users_userid_foreign FOREIGN KEY ("userId") REFERENCES public.users(id);
...
ALTER TABLE
    ONLY public.teams
ADD
    CONSTRAINT teams_ssogithubaccountid_foreign FOREIGN KEY ("ssoGithubAccountId") REFERENCES public.github_accounts(id);
...
ALTER TABLE
    ONLY public.test_stats_builds
ADD
    CONSTRAINT test_stats_builds_testid_foreign FOREIGN KEY ("testId") REFERENCES public.tests(id);
...
ALTER TABLE
    ONLY public.test_stats_fingerprints
ADD
    CONSTRAINT test_stats_fingerprints_testid_foreign FOREIGN KEY ("testId") REFERENCES public.tests(id);
...
ALTER TABLE
    ONLY public.tests
ADD
    CONSTRAINT tests_projectid_foreign FOREIGN KEY ("projectId") REFERENCES public.projects(id);
...
ALTER TABLE
    ONLY public.user_access_token_scopes
ADD
    CONSTRAINT user_access_token_scopes_accountid_foreign FOREIGN KEY ("accountId") REFERENCES public.accounts(id) ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.user_access_token_scopes
ADD
    CONSTRAINT user_access_token_scopes_useraccesstokenid_foreign FOREIGN KEY ("userAccessTokenId") REFERENCES public.user_access_tokens(id) ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.user_access_tokens
ADD
    CONSTRAINT user_access_tokens_userid_foreign FOREIGN KEY ("userId") REFERENCES public.users(id) ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.user_emails
ADD
    CONSTRAINT user_emails_userid_foreign FOREIGN KEY ("userId") REFERENCES public.users(id) ON DELETE CASCADE;
...
ALTER TABLE
    ONLY public.users
ADD
    CONSTRAINT users_gitlabuserid_foreign FOREIGN KEY ("gitlabUserId") REFERENCES public.gitlab_users(id);
...
ALTER TABLE
    ONLY public.users
ADD
    CONSTRAINT users_googleuserid_fk_foreign FOREIGN KEY ("googleUserId") REFERENCES public.google_users(id);
...
-- Knex migrations
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20161217154940_init.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20170128163909_screenshot_buckets_drop_column_jobStatus.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20170128165351_builds_alter_column_baseScreenshotBucketId.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20170128165352_screenshot_diffs_alter_column_score.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20170128165353_screenshot_diffs_alter_column_score.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20170129135917_link_repositories.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20170129213906_screenshot_diffs_add_column_s3id.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20170205204435_organization-repository.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20170211133332_add_table_synchronizations.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20170211153730_users_add_column_accessToken.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20170211165500_create_table_user_organization_rights.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20170211165501_create_table_user_repository_rights.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20170212091412_users_email_remove_not_null.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20170212092004_add_column_userId_to_repositories.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20170212102433_repositories_alter_column_organization_id.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20170222000548_users_name_login.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20170222000549_builds_number.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20170222222346_add_jobStatus_to_builds.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20170304184220_add_constraints.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20170304184221_remove_constraints.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20170305095107_notifications.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20170306205356_new-notifications.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20170312191852_users_add_private_enabled.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20170312202055_repositories_add_column_private.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20170312230324_organizations_login.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20170319114827_add_github_scopes_to_users.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20170329213934_allow_null_baseScreenshotIds.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20170402203440_repository_baseline_branch.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20170628232300_add_scopes_to_users.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20180323213911_screenshot_batches.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20181017110213_indexes.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20190919113147_bucket-status.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20190919154131_job_status_aborted.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20200329104003_github-app.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20200329194617_build-notifications.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20200616135126_build-name.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20220803095315_add_plans.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20220809113257_add_purchase_end_date.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20220812142703_files.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20220814071435_screenshot_diffs_indexes.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20220902165449_repository_github_default_branch.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20220905174153_remove_use_default_branch.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20220909111750_add_build_type.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20220912221410_add_build_parallel_total.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20220918102241_fix_accounts_only_one_non_null_constraint.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20220918153730_add_old_build_type.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20220919175105_nullable_compare_screenshot_id.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20220921142914_remove.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20220927074934_add_missing_accounts.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20221013113904_add_forced_plan.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20221104162900_add_files_dimensions.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20221123165000_add_indexes.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20221203103833_installation_token.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20221213130347_stripe.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20221228140518_add_missing_accounts.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230102064502_add_forced_private.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230103095309_add_pr_number.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20230218100910_add_stability_score.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230313131422_add_tests_table.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230323071510_add_mute_to_tests.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230416201920_crawls.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230417193649_isolate.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230418095958_project-not-null.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20230418125037_user-github-account-id.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20230418130232_simplify-github-account.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230418133221_simplify-account.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20230418154104_remove-github-installation-accounts.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20230418191815_non-nullable-github-repo.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230423073805_team-invite-link.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230423170603_slug-unique.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230423195916_no-project-slug.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20230426123607_screenshot-diff-index.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20230427131915_require_purchase_startDate.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230428122453_vercel-data.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230429125237_add_purchase_trial.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20230430182249_multiple-project-repo.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20230501135647_add_plan_usage_type.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230503215250_buckets-count.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230504073924_buckets_constraint.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20230504075127_buckets_complete_default_false.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20230505112219_add_purchase_payment_method_filled.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230524074946_build-reference.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230625185103_vercel-checks.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230703200439_test-name-length.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230708213033_github_pr_comment.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20230712193423_purchase-subscription-id.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20230714125556_build-pr-head-commit.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230826091827_gitlab_users.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230827144239_gitlab_acess_token.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230830151208_gitlab_projects.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20230930081123_add_diffs_group.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20231017142204_screenshot_metadata.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20231020163248_github-pull-request-job-status.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20231024072202_github-draft-merged.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20231024085955_fix-github-account-type-constraint.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20231106114751_pw-traces.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20231115151718_file-type.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20231115160027_playwrightTraceIndex.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20231115210334_file-type-not-null.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20231122143018_add-purchase-status.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20240108211747_project-status-check.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20240121215150_github-sso.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20240202080857_staff-user.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20240203212814_renaming.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20240204080614_subscriptions_included_screenshots.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20240219213539_subscriptions_big_integer.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20240222154748_not-nullable-payment-method-filled.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20240301151709_screenshot-diffs-index.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20240307081941_project_users.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20240309214656_clean_vercel.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20240329130227_googleUserId.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20240330152633_gitlab-on-prem.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20240428061335_monitoring-mode.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20240428200226_monitoring-mode-bucket.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20240505121926_slack-installation.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20240604133729_comment_id_big_integer.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20240614204320_build_shards.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20240616142430_build_shards_indices.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20240630151704_screenshot-threshold.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20240706121810_screenshot-base-name.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20240822082247_github-light.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20240901150444_build-metadata.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20241006153157_reference-branch.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20241008035928_fix-enum.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20241011152207_parent-commits.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20241201074304_github-access-token.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20241201100628_remove-github-access-token.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20241201210158_google-account.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20241201222408_gitlab-last-loggedat.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20241215091232_project-default-role.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20241231154644_build-status.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20250102150800_build-review.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20250103090503_remove-validation-status-column.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20250103131406_plan-interval.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20250105124212_spend-management.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20250105130307_remove-crawls-captures.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20250111204217_user-notifications.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20250113180732_clean-additional-screenshot-price.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20250119081939_slack_channels.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20250202084159_cleanup-test-table.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20250505143128_proxy-github.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20250523070743_create_automation_tables.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20250524183823_clean-stability-store.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20250602091017_test-stats.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20250607160713_remove-test-activities.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20250617171538_slack-connected-at.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20250622134309_ignored-files.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20250629170855_screenshot-diffs-ignore.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20250705083915_deleted-users.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20250803194148_storybook-count.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20250808202617_screenshot-diff-review.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20250808204525_build-review-state.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20250820130012_build-dates.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20250820183342_slack-channel.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20250820184542_automation-processed-at.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20250820184634_remove-automation-job-status.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20250820185036_slack-channel-id.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20250821180259_user-emails.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20250822020923_github-account-emails.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20250911075747_additional-storybook-screenshot-price.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20250915191132_team_invites.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20250929110439_build_skipped.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20251009205806_unique_account_githubAccountId.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20251019194629_snapshot.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20251101104030_parent-screenshot.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20251212130537_merge-queue.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20260112163920_fingerprint-screenshot-diffs.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20260112165048_fingerprint-files.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20260118053630_fingerprint-ignore.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20260118080430_comment-fingerprint.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20260118195213_test-stats-fingerprints.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20260119154332_delete-unused-tables.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20260119203427_user-type.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20260125185235_add-indices.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20260131141626_removed-screenshot-policy.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20260215121000_team_saml_configs.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20260216200736_enforce-sso.js', 1, NOW());

INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    (
        '20260219170000_project-auto-ignore.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20260222100000_team-saml-expiration-check.js',
        1,
        NOW()
    );
...
VALUES
    (
        '20260328120000_build-merge-queue-gh-pull-requests.js',
        1,
        NOW()
    );
...
INSERT INTO
    public.knex_migrations(name, batch, migration_time)
VALUES
    ('20260401084427_user_access_tokens.js', 1, NOW());