...
export type IResolversInterfaceTypes<RefType extends Record<string, unknown>> =
  ResolversObject<{
    ...
    Connection:
      | (Omit<IBuildConnection, "edges"> & { edges: Array<RefType["Build"]> })
      | (Omit<IGhApiInstallationConnection, "edges"> & {
          edges: Array<RefType["GhApiInstallation"]>;
        })
      | (Omit<IGhApiRepositoryConnection, "edges"> & {
          edges: Array<RefType["GhApiRepository"]>;
        })
      | (Omit<IGlApiNamespaceConnection, "edges"> & {
          edges: Array<RefType["GlApiNamespace"]>;
        })
      | (Omit<IGlApiProjectConnection, "edges"> & {
          edges: Array<RefType["GlApiProject"]>;
        })
      | (Omit<IProjectConnection, "edges"> & {
          edges: Array<RefType["Project"]>;
        })
      | (Omit<IScreenshotDiffConnection, "edges"> & {
          edges: Array<RefType["ScreenshotDiff"]>;
        })
      | (Omit<ITeamMemberConnection, "edges"> & {
          edges: Array<RefType["TeamMember"]>;
        })
      | (Omit<ITestConnection, "edges"> & { edges: Array<RefType["Test"]> })
      | (Omit<IUserConnection, "edges"> & { edges: Array<RefType["User"]> });
    Node:
      | Build
      | GhApiInstallation
    ...
    VercelApiProjectLink:
      | IVercelApiProjectLinkGithub
      | IVercelApiProjectLinkOther;
  }>;

/** Mapping between all available schema types and the resolvers types */
export type IResolversTypes = ResolversObject<{
  Account: ResolverTypeWrapper<
    IResolversInterfaceTypes<IResolversTypes>["Account"]
  >;
  AccountAvatar: ResolverTypeWrapper<AccountAvatar>;
  Boolean: ResolverTypeWrapper<Scalars["Boolean"]["output"]>;
  Build: ResolverTypeWrapper<Build>;
  BuildConnection: ResolverTypeWrapper<
    Omit<IBuildConnection, "edges"> & { edges: Array<IResolversTypes["Build"]> }
  >;
  BuildStats: ResolverTypeWrapper<IBuildStats>;
  BuildStatus: IBuildStatus;
  BuildType: IBuildType;
  Connection: ResolverTypeWrapper<
    IResolversInterfaceTypes<IResolversTypes>["Connection"]
  >;
  CreateTeamInput: ICreateTeamInput;
  CreateTeamResult: ResolverTypeWrapper<
    Omit<ICreateTeamResult, "team"> & { team: IResolversTypes["Team"] }
  >;
  ...
  GhApiInstallationConnection: ResolverTypeWrapper<
    Omit<IGhApiInstallationConnection, "edges"> & {
      edges: Array<IResolversTypes["GhApiInstallation"]>;
    }
  >;
  GhApiRepository: ResolverTypeWrapper<GhApiRepository>;
  GhApiRepositoryConnection: ResolverTypeWrapper<
    Omit<IGhApiRepositoryConnection, "edges"> & {
      edges: Array<IResolversTypes["GhApiRepository"]>;
    }
  >;
  ...
  GlApiNamespaceConnection: ResolverTypeWrapper<
    Omit<IGlApiNamespaceConnection, "edges"> & {
      edges: Array<IResolversTypes["GlApiNamespace"]>;
    }
  >;
  GlApiProject: ResolverTypeWrapper<GlApiProject>;
  GlApiProjectConnection: ResolverTypeWrapper<
    Omit<IGlApiProjectConnection, "edges"> & {
      edges: Array<IResolversTypes["GlApiProject"]>;
    }
  >;
  ...
  ProjectConnection: ResolverTypeWrapper<
    Omit<IProjectConnection, "edges"> & {
      edges: Array<IResolversTypes["Project"]>;
    }
  >;
  ...
  Repository: ResolverTypeWrapper<
    IResolversInterfaceTypes<IResolversTypes>["Repository"]
  >;
  ...
  ScreenshotDiffConnection: ResolverTypeWrapper<
    Omit<IScreenshotDiffConnection, "edges"> & {
      edges: Array<IResolversTypes["ScreenshotDiff"]>;
    }
  >;
  ...
  TeamMemberConnection: ResolverTypeWrapper<
    Omit<ITeamMemberConnection, "edges"> & {
      edges: Array<IResolversTypes["TeamMember"]>;
    }
  >;
  TeamUserLevel: ITeamUserLevel;
  Test: ResolverTypeWrapper<Test>;
  TestConnection: ResolverTypeWrapper<
    Omit<ITestConnection, "edges"> & { edges: Array<IResolversTypes["Test"]> }
  >;
  ...
  UserConnection: ResolverTypeWrapper<
    Omit<IUserConnection, "edges"> & { edges: Array<IResolversTypes["User"]> }
  >;
  ValidationStatus: IValidationStatus;
  VercelApiPagination: ResolverTypeWrapper<IVercelApiPagination>;
  VercelApiProject: ResolverTypeWrapper<VercelApiProject>;
  VercelApiProjectConnection: ResolverTypeWrapper<
    Omit<IVercelApiProjectConnection, "projects"> & {
      projects: Array<IResolversTypes["VercelApiProject"]>;
    }
  >;
  VercelApiProjectLink: ResolverTypeWrapper<
    IResolversInterfaceTypes<IResolversTypes>["VercelApiProjectLink"]
  >;
...
export type IResolversParentTypes = ResolversObject<{
  ...
  Build: Build;
  BuildConnection: Omit<IBuildConnection, "edges"> & {
    edges: Array<IResolversParentTypes["Build"]>;
  };
  BuildStats: IBuildStats;
  Connection: IResolversInterfaceTypes<IResolversParentTypes>["Connection"];
  CreateTeamInput: ICreateTeamInput;
  CreateTeamResult: Omit<ICreateTeamResult, "team"> & {
    team: IResolversParentTypes["Team"];
  };
  Date: Scalars["Date"]["output"];
  ...
  GhApiInstallationConnection: Omit<IGhApiInstallationConnection, "edges"> & {
    edges: Array<IResolversParentTypes["GhApiInstallation"]>;
  };
  GhApiRepository: GhApiRepository;
  GhApiRepositoryConnection: Omit<IGhApiRepositoryConnection, "edges"> & {
    edges: Array<IResolversParentTypes["GhApiRepository"]>;
  };
  GithubAccount: GithubAccount;
  GithubRepository: GithubRepository;
  GitlabProject: GitlabProject;
  GlApiNamespace: GlApiNamespace;
  GlApiNamespaceConnection: Omit<IGlApiNamespaceConnection, "edges"> & {
    edges: Array<IResolversParentTypes["GlApiNamespace"]>;
  };
  GlApiProject: GlApiProject;
  GlApiProjectConnection: Omit<IGlApiProjectConnection, "edges"> & {
    edges: Array<IResolversParentTypes["GlApiProject"]>;
  };
  ID: Scalars["ID"]["output"];
  ImportGithubProjectInput: IImportGithubProjectInput;
  ImportGitlabProjectInput: IImportGitlabProjectInput;
  ...
  Plan: Plan;
  Project: Project;
  ProjectConnection: Omit<IProjectConnection, "edges"> & {
    edges: Array<IResolversParentTypes["Project"]>;
  };
  Purchase: Purchase;
  Query: {};
  RemoveUserFromTeamInput: IRemoveUserFromTeamInput;
  ...
  ScreenshotDiffConnection: Omit<IScreenshotDiffConnection, "edges"> & {
    edges: Array<IResolversParentTypes["ScreenshotDiff"]>;
  };
  SetTeamMemberLevelInput: ISetTeamMemberLevelInput;
  SetupVercelIntegrationInput: ISetupVercelIntegrationInput;
  SetupVercelIntegrationProjectInput: ISetupVercelIntegrationProjectInput;
  ...
  Team: Account;
  TeamMember: TeamUser;
  TeamMemberConnection: Omit<ITeamMemberConnection, "edges"> & {
    edges: Array<IResolversParentTypes["TeamMember"]>;
  };
  Test: Test;
  TestConnection: Omit<ITestConnection, "edges"> & {
    edges: Array<IResolversParentTypes["Test"]>;
  };
  ...
  User: Account;
  UserConnection: Omit<IUserConnection, "edges"> & {
    edges: Array<IResolversParentTypes["User"]>;
  };
  VercelApiPagination: IVercelApiPagination;
  VercelApiProject: VercelApiProject;
  VercelApiProjectConnection: Omit<IVercelApiProjectConnection, "projects"> & {
    projects: Array<IResolversParentTypes["VercelApiProject"]>;
  };
...
export type IAccountResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["Account"] = IResolversParentTypes["Account"],
> = ResolversObject<{
  ...
  consumptionRatio?: Resolver<
    Maybe<IResolversTypes["Float"]>,
    ParentType,
    ContextType
  >;
  currentMonthUsedScreenshots?: Resolver<
    IResolversTypes["Int"],
    ParentType,
    ContextType
  >;
  ghAccount?: Resolver<
    Maybe<IResolversTypes["GithubAccount"]>,
    ParentType,
    ContextType
  >;
  gitlabAccessToken?: Resolver<
    Maybe<IResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  glNamespaces?: Resolver<
    Maybe<IResolversTypes["GlApiNamespaceConnection"]>,
    ParentType,
    ContextType
  >;
  ...
  paymentProvider?: Resolver<
    Maybe<IResolversTypes["PurchaseSource"]>,
    ParentType,
    ContextType
  >;
  pendingCancelAt?: Resolver<
    Maybe<IResolversTypes["DateTime"]>,
    ParentType,
    ContextType
  >;
  periodEndDate?: Resolver<
    ...
    ContextType
  >;
  periodStartDate?: Resolver<
    Maybe<IResolversTypes["DateTime"]>,
    ParentType,
    ContextType
  >;
  permissions?: Resolver<
    Array<IResolversTypes["Permission"]>,
    ParentType,
    ContextType
  >;
  ...
  projects?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<IAccountProjectsArgs, "after" | "first">
  >;
  purchase?: Resolver<
    Maybe<IResolversTypes["Purchase"]>,
    ParentType,
    ContextType
  >;
  purchaseStatus?: Resolver<
    Maybe<IResolversTypes["PurchaseStatus"]>,
    ParentType,
    ContextType
  >;
  screenshotsLimitPerMonth?: Resolver<
    Maybe<IResolversTypes["Int"]>,
    ParentType,
    ContextType
  >;
  slug?: Resolver<IResolversTypes["String"], ParentType, ContextType>;
  stripeClientReferenceId?: Resolver<
  ...
  stripeCustomerId?: Resolver<
    ...
    ContextType
  >;
  trialStatus?: Resolver<
    Maybe<IResolversTypes["TrialStatus"]>,
    ParentType,
    ContextType
  >;
  vercelConfiguration?: Resolver<
    Maybe<IResolversTypes["VercelConfiguration"]>,
    ParentType,
    ContextType
  >;
}>;

export type IAccountAvatarResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["AccountAvatar"] = IResolversParentTypes["AccountAvatar"],
> = ResolversObject<{
  ...
  url?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<IAccountAvatarUrlArgs, "size">
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type IBuildResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["Build"] = IResolversParentTypes["Build"],
> = ResolversObject<{
  baseScreenshotBucket?: Resolver<
    Maybe<IResolversTypes["ScreenshotBucket"]>,
    ParentType,
    ContextType
  >;
  ...
  prHeadCommit?: Resolver<
    Maybe<IResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  prNumber?: Resolver<Maybe<IResolversTypes["Int"]>, ParentType, ContextType>;
  screenshotDiffs?: Resolver<
    IResolversTypes["ScreenshotDiffConnection"],
    ParentType,
    ContextType,
    RequireFields<IBuildScreenshotDiffsArgs, "after" | "first">
  >;
...
export type IBuildConnectionResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["BuildConnection"] = IResolversParentTypes["BuildConnection"],
> = ResolversObject<{
...
export type IBuildStatsResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["BuildStats"] = IResolversParentTypes["BuildStats"],
> = ResolversObject<{
...
export type IConnectionResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["Connection"] = IResolversParentTypes["Connection"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    | "BuildConnection"
    | "GhApiInstallationConnection"
    | "GhApiRepositoryConnection"
    | "GlApiNamespaceConnection"
...
export type ICreateTeamResultResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["CreateTeamResult"] = IResolversParentTypes["CreateTeamResult"],
> = ResolversObject<{
...
export type IGhApiInstallationResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["GhApiInstallation"] = IResolversParentTypes["GhApiInstallation"],
> = ResolversObject<{
  account?: Resolver<
    IResolversTypes["GhApiInstallationAccount"],
    ParentType,
    ContextType
  >;
  id?: Resolver<IResolversTypes["ID"], ParentType, ContextType>;
...
export type IGhApiInstallationAccountResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["GhApiInstallationAccount"] = IResolversParentTypes["GhApiInstallationAccount"],
> = ResolversObject<{
  id?: Resolver<IResolversTypes["ID"], ParentType, ContextType>;
...
export type IGhApiInstallationConnectionResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["GhApiInstallationConnection"] = IResolversParentTypes["GhApiInstallationConnection"],
> = ResolversObject<{
  edges?: Resolver<
    Array<IResolversTypes["GhApiInstallation"]>,
    ParentType,
    ContextType
  >;
  pageInfo?: Resolver<IResolversTypes["PageInfo"], ParentType, ContextType>;
...
export type IGhApiRepositoryResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["GhApiRepository"] = IResolversParentTypes["GhApiRepository"],
> = ResolversObject<{
  id?: Resolver<IResolversTypes["ID"], ParentType, ContextType>;
  name?: Resolver<IResolversTypes["String"], ParentType, ContextType>;
...
export type IGhApiRepositoryConnectionResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["GhApiRepositoryConnection"] = IResolversParentTypes["GhApiRepositoryConnection"],
> = ResolversObject<{
  edges?: Resolver<
    Array<IResolversTypes["GhApiRepository"]>,
    ParentType,
    ContextType
  >;
  pageInfo?: Resolver<IResolversTypes["PageInfo"], ParentType, ContextType>;
...
export type IGithubAccountResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["GithubAccount"] = IResolversParentTypes["GithubAccount"],
> = ResolversObject<{
  id?: Resolver<IResolversTypes["ID"], ParentType, ContextType>;
  login?: Resolver<IResolversTypes["String"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type IGithubRepositoryResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["GithubRepository"] = IResolversParentTypes["GithubRepository"],
> = ResolversObject<{
...
export type IGitlabProjectResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["GitlabProject"] = IResolversParentTypes["GitlabProject"],
> = ResolversObject<{
  defaultBranch?: Resolver<IResolversTypes["String"], ParentType, ContextType>;
  fullName?: Resolver<IResolversTypes["String"], ParentType, ContextType>;
  id?: Resolver<IResolversTypes["ID"], ParentType, ContextType>;
...
export type IGlApiNamespaceResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["GlApiNamespace"] = IResolversParentTypes["GlApiNamespace"],
> = ResolversObject<{
  id?: Resolver<IResolversTypes["ID"], ParentType, ContextType>;
...
export type IGlApiNamespaceConnectionResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["GlApiNamespaceConnection"] = IResolversParentTypes["GlApiNamespaceConnection"],
> = ResolversObject<{
  edges?: Resolver<
    Array<IResolversTypes["GlApiNamespace"]>,
    ParentType,
    ContextType
  >;
  pageInfo?: Resolver<IResolversTypes["PageInfo"], ParentType, ContextType>;
...
export type IGlApiProjectResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["GlApiProject"] = IResolversParentTypes["GlApiProject"],
> = ResolversObject<{
  id?: Resolver<IResolversTypes["ID"], ParentType, ContextType>;
  ...
  name?: Resolver<IResolversTypes["String"], ParentType, ContextType>;
  namespace?: Resolver<
    IResolversTypes["GlApiNamespace"],
    ParentType,
    ContextType
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type IGlApiProjectConnectionResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["GlApiProjectConnection"] = IResolversParentTypes["GlApiProjectConnection"],
> = ResolversObject<{
  edges?: Resolver<
    Array<IResolversTypes["GlApiProject"]>,
    ParentType,
    ContextType
  >;
  pageInfo?: Resolver<IResolversTypes["PageInfo"], ParentType, ContextType>;
...
> = ResolversObject<{
  acceptInvitation?: Resolver<
    IResolversTypes["Team"],
    ParentType,
    ContextType,
    RequireFields<IMutationAcceptInvitationArgs, "token">
  >;
  createTeam?: Resolver<
    IResolversTypes["CreateTeamResult"],
    ParentType,
    ContextType,
    RequireFields<IMutationCreateTeamArgs, "input">
  >;
  deleteProject?: Resolver<
    IResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<IMutationDeleteProjectArgs, "id">
  >;
  deleteTeam?: Resolver<
    IResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<IMutationDeleteTeamArgs, "input">
  >;
  importGithubProject?: Resolver<
    IResolversTypes["Project"],
    ParentType,
    ContextType,
    RequireFields<IMutationImportGithubProjectArgs, "input">
  >;
  importGitlabProject?: Resolver<
    IResolversTypes["Project"],
    ParentType,
    ContextType,
    RequireFields<IMutationImportGitlabProjectArgs, "input">
  >;
  leaveTeam?: Resolver<
    IResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<IMutationLeaveTeamArgs, "input">
  >;
  linkGithubRepository?: Resolver<
    IResolversTypes["Project"],
    ParentType,
    ContextType,
    RequireFields<IMutationLinkGithubRepositoryArgs, "input">
  >;
  linkGitlabProject?: Resolver<
    IResolversTypes["Project"],
    ParentType,
    ContextType,
    RequireFields<IMutationLinkGitlabProjectArgs, "input">
  >;
  linkVercelProject?: Resolver<
    IResolversTypes["Project"],
    ParentType,
    ContextType,
    RequireFields<IMutationLinkVercelProjectArgs, "input">
  >;
  muteTests?: Resolver<
    IResolversTypes["MuteUpdateTest"],
    ParentType,
    ContextType,
    RequireFields<IMutationMuteTestsArgs, "ids" | "muted">
  >;
  ping?: Resolver<IResolversTypes["Boolean"], ParentType, ContextType>;
  removeUserFromTeam?: Resolver<
    IResolversTypes["RemoveUserFromTeamPayload"],
    ParentType,
    ContextType,
    RequireFields<IMutationRemoveUserFromTeamArgs, "input">
  >;
  retrieveVercelToken?: Resolver<
    IResolversTypes["VercelApiToken"],
    ParentType,
    ContextType,
    RequireFields<IMutationRetrieveVercelTokenArgs, "code">
  >;
  setTeamMemberLevel?: Resolver<
    IResolversTypes["TeamMember"],
    ParentType,
    ContextType,
    RequireFields<IMutationSetTeamMemberLevelArgs, "input">
  >;
  setValidationStatus?: Resolver<
    IResolversTypes["Build"],
    ParentType,
    ContextType,
    RequireFields<
      IMutationSetValidationStatusArgs,
      "buildId" | "validationStatus"
    >
  >;
  setupVercelIntegration?: Resolver<
    Maybe<IResolversTypes["Boolean"]>,
    ParentType,
    ContextType,
    RequireFields<IMutationSetupVercelIntegrationArgs, "input">
  >;
  terminateTrial?: Resolver<
    IResolversTypes["Account"],
    ParentType,
    ContextType,
    RequireFields<IMutationTerminateTrialArgs, "accountId">
  >;
  transferProject?: Resolver<
    IResolversTypes["Project"],
    ParentType,
    ContextType,
    RequireFields<IMutationTransferProjectArgs, "input">
  >;
  unlinkGithubRepository?: Resolver<
    IResolversTypes["Project"],
    ParentType,
    ContextType,
    RequireFields<IMutationUnlinkGithubRepositoryArgs, "input">
  >;
  unlinkGitlabProject?: Resolver<
    IResolversTypes["Project"],
    ParentType,
    ContextType,
    RequireFields<IMutationUnlinkGitlabProjectArgs, "input">
  >;
  unlinkVercelProject?: Resolver<
    IResolversTypes["Project"],
    ParentType,
    ContextType,
    RequireFields<IMutationUnlinkVercelProjectArgs, "input">
  >;
  updateAccount?: Resolver<
    IResolversTypes["Account"],
    ParentType,
    ContextType,
    RequireFields<IMutationUpdateAccountArgs, "input">
  >;
  updateProject?: Resolver<
    IResolversTypes["Project"],
    ParentType,
    ContextType,
    RequireFields<IMutationUpdateProjectArgs, "input">
  >;
  updateProjectPrComment?: Resolver<
    IResolversTypes["Project"],
    ParentType,
    ContextType,
    RequireFields<IMutationUpdateProjectPrCommentArgs, "input">
  >;
  updateTestStatuses?: Resolver<
    IResolversTypes["UpdatedTestStatuses"],
    ParentType,
    ContextType,
    RequireFields<IMutationUpdateTestStatusesArgs, "ids" | "status">
  >;
}>;

export type IMuteUpdateTestResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["MuteUpdateTest"] = IResolversParentTypes["MuteUpdateTest"],
> = ResolversObject<{
...
export type INodeResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["Node"] = IResolversParentTypes["Node"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    | "Build"
    | "GhApiInstallation"
...
export type IPlanResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["Plan"] = IResolversParentTypes["Plan"],
> = ResolversObject<{
  id?: Resolver<IResolversTypes["ID"], ParentType, ContextType>;
  name?: Resolver<IResolversTypes["String"], ParentType, ContextType>;
  screenshotsLimitPerMonth?: Resolver<
...
export type IProjectResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["Project"] = IResolversParentTypes["Project"],
> = ResolversObject<{
  account?: Resolver<IResolversTypes["Account"], ParentType, ContextType>;
  baselineBranch?: Resolver<
    Maybe<IResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  build?: Resolver<
    Maybe<IResolversTypes["Build"]>,
    ParentType,
    ContextType,
    RequireFields<IProjectBuildArgs, "number">
  >;
  builds?: Resolver<
    IResolversTypes["BuildConnection"],
    ParentType,
    ContextType,
    RequireFields<IProjectBuildsArgs, "after" | "first">
  >;
  currentMonthUsedScreenshots?: Resolver<
    IResolversTypes["Int"],
    ParentType,
  ...
  >;
  id?: Resolver<IResolversTypes["ID"], ParentType, ContextType>;
  latestBuild?: Resolver<
    Maybe<IResolversTypes["Build"]>,
    ParentType,
    ContextType
  >;
  latestReferenceBuild?: Resolver<
    Maybe<IResolversTypes["Build"]>,
    ParentType,
    ContextType
  >;
  ...
  referenceBranch?: Resolver<
    Maybe<IResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  repository?: Resolver<
    Maybe<IResolversTypes["Repository"]>,
    ParentType,
    ContextType
  >;
  slug?: Resolver<IResolversTypes["String"], ParentType, ContextType>;
  tests?: Resolver<
    IResolversTypes["TestConnection"],
    ParentType,
    ContextType,
    RequireFields<IProjectTestsArgs, "after" | "first">
  >;
  token?: Resolver<Maybe<IResolversTypes["String"]>, ParentType, ContextType>;
  totalScreenshots?: Resolver<IResolversTypes["Int"], ParentType, ContextType>;
  vercelProject?: Resolver<
    Maybe<IResolversTypes["VercelProject"]>,
    ParentType,
    ContextType
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type IProjectConnectionResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["ProjectConnection"] = IResolversParentTypes["ProjectConnection"],
> = ResolversObject<{
...
export type IPurchaseResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["Purchase"] = IResolversParentTypes["Purchase"],
> = ResolversObject<{
  id?: Resolver<IResolversTypes["ID"], ParentType, ContextType>;
  paymentMethodFilled?: Resolver<
    IResolversTypes["Boolean"],
    ParentType,
    ContextType
  >;
  source?: Resolver<IResolversTypes["PurchaseSource"], ParentType, ContextType>;
  trialDaysRemaining?: Resolver<
    Maybe<IResolversTypes["Int"]>,
    ParentType,
    ContextType
  >;
...
> = ResolversObject<{
  account?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<IQueryAccountArgs, "slug">
  >;
  accountById?: Resolver<
    Maybe<IResolversTypes["Account"]>,
    ParentType,
    ContextType,
    RequireFields<IQueryAccountByIdArgs, "id">
  >;
  ghApiInstallationRepositories?: Resolver<
    IResolversTypes["GhApiRepositoryConnection"],
    ParentType,
    ContextType,
    RequireFields<
      IQueryGhApiInstallationRepositoriesArgs,
      "installationId" | "page"
    >
  >;
  glApiProjects?: Resolver<
    IResolversTypes["GlApiProjectConnection"],
    ParentType,
    ContextType,
    RequireFields<IQueryGlApiProjectsArgs, "accessToken" | "page">
  >;
  invitation?: Resolver<
    Maybe<IResolversTypes["Team"]>,
    ParentType,
    ContextType,
    RequireFields<IQueryInvitationArgs, "token">
  >;
  ...
  project?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<IQueryProjectArgs, "accountSlug" | "projectName">
  >;
  projectById?: Resolver<
    Maybe<IResolversTypes["Project"]>,
    ParentType,
    ContextType,
    RequireFields<IQueryProjectByIdArgs, "id">
  >;
  teamById?: Resolver<
    Maybe<IResolversTypes["Team"]>,
    ParentType,
    ContextType,
    RequireFields<IQueryTeamByIdArgs, "id">
  >;
  vercelApiProjects?: Resolver<
    IResolversTypes["VercelApiProjectConnection"],
    ParentType,
    ContextType,
    RequireFields<IQueryVercelApiProjectsArgs, "accessToken">
  >;
  vercelApiTeam?: Resolver<
    Maybe<IResolversTypes["VercelApiTeam"]>,
    ParentType,
    ContextType,
    RequireFields<IQueryVercelApiTeamArgs, "accessToken" | "id">
  >;
}>;

export type IRemoveUserFromTeamPayloadResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["RemoveUserFromTeamPayload"] = IResolversParentTypes["RemoveUserFromTeamPayload"],
> = ResolversObject<{
  teamMemberId?: Resolver<IResolversTypes["ID"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type IRepositoryResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["Repository"] = IResolversParentTypes["Repository"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<
...
export type IScreenshotResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["Screenshot"] = IResolversParentTypes["Screenshot"],
> = ResolversObject<{
...
export type IScreenshotBucketResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["ScreenshotBucket"] = IResolversParentTypes["ScreenshotBucket"],
> = ResolversObject<{
  branch?: Resolver<IResolversTypes["String"], ParentType, ContextType>;
  commit?: Resolver<IResolversTypes["String"], ParentType, ContextType>;
  createdAt?: Resolver<IResolversTypes["DateTime"], ParentType, ContextType>;
...
export type IScreenshotDiffResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["ScreenshotDiff"] = IResolversParentTypes["ScreenshotDiff"],
> = ResolversObject<{
  baseScreenshot?: Resolver<
    Maybe<IResolversTypes["Screenshot"]>,
    ParentType,
    ContextType
  >;
  compareScreenshot?: Resolver<
    Maybe<IResolversTypes["Screenshot"]>,
    ParentType,
    ContextType
  >;
  ...
  name?: Resolver<IResolversTypes["String"], ParentType, ContextType>;
  status?: Resolver<
    IResolversTypes["ScreenshotDiffStatus"],
    ParentType,
    ContextType
  >;
...
export type IScreenshotDiffConnectionResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["ScreenshotDiffConnection"] = IResolversParentTypes["ScreenshotDiffConnection"],
> = ResolversObject<{
  edges?: Resolver<
    Array<IResolversTypes["ScreenshotDiff"]>,
    ParentType,
    ContextType
  >;
  pageInfo?: Resolver<IResolversTypes["PageInfo"], ParentType, ContextType>;
...
export type ITeamResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["Team"] = IResolversParentTypes["Team"],
> = ResolversObject<{
  avatar?: Resolver<IResolversTypes["AccountAvatar"], ParentType, ContextType>;
  consumptionRatio?: Resolver<
    Maybe<IResolversTypes["Float"]>,
  ...
  members?: Resolver<
    IResolversTypes["TeamMemberConnection"],
    ParentType,
    ContextType,
    RequireFields<ITeamMembersArgs, "after" | "first">
  >;
  name?: Resolver<Maybe<IResolversTypes["String"]>, ParentType, ContextType>;
  oldPaidPurchase?: Resolver<
    Maybe<IResolversTypes["Purchase"]>,
    ParentType,
    ContextType
  >;
  ...
  projects?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<ITeamProjectsArgs, "after" | "first">
  >;
  purchase?: Resolver<
    Maybe<IResolversTypes["Purchase"]>,
    ParentType,
...
export type ITeamMemberResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["TeamMember"] = IResolversParentTypes["TeamMember"],
> = ResolversObject<{
  id?: Resolver<IResolversTypes["ID"], ParentType, ContextType>;
...
export type ITeamMemberConnectionResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["TeamMemberConnection"] = IResolversParentTypes["TeamMemberConnection"],
> = ResolversObject<{
  edges?: Resolver<
    Array<IResolversTypes["TeamMember"]>,
    ParentType,
    ContextType
  >;
  pageInfo?: Resolver<IResolversTypes["PageInfo"], ParentType, ContextType>;
...
export type ITestResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["Test"] = IResolversParentTypes["Test"],
> = ResolversObject<{
  buildName?: Resolver<IResolversTypes["String"], ParentType, ContextType>;
  dailyChanges?: Resolver<
    Array<IResolversTypes["dailyCount"]>,
    ParentType,
    ContextType
  >;
  id?: Resolver<IResolversTypes["ID"], ParentType, ContextType>;
...
export type ITestConnectionResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["TestConnection"] = IResolversParentTypes["TestConnection"],
> = ResolversObject<{
...
export type IUpdatedTestStatusesResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["UpdatedTestStatuses"] = IResolversParentTypes["UpdatedTestStatuses"],
> = ResolversObject<{
  ids?: Resolver<Array<IResolversTypes["String"]>, ParentType, ContextType>;
  status?: Resolver<IResolversTypes["TestStatus"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
> = ResolversObject<{
  ...
  ghAccount?: Resolver<
    ...
    ContextType
  >;
  ghInstallations?: Resolver<
    IResolversTypes["GhApiInstallationConnection"],
    ParentType,
    ContextType
  >;
  gitlabAccessToken?: Resolver<
  ...
  hasForcedPlan?: Resolver<IResolversTypes["Boolean"], ParentType, ContextType>;
  hasPaidPlan?: Resolver<IResolversTypes["Boolean"], ParentType, ContextType>;
  hasSubscribedToTrial?: Resolver<
    IResolversTypes["Boolean"],
    ParentType,
    ContextType
  >;
  id?: Resolver<IResolversTypes["ID"], ParentType, ContextType>;
  lastPurchase?: Resolver<
    Maybe<IResolversTypes["Purchase"]>,
    ParentType,
    ContextType
  >;
  ...
  projects?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<IUserProjectsArgs, "after" | "first">
  >;
  purchase?: Resolver<
    Maybe<IResolversTypes["Purchase"]>,
    ParentType,
...
export type IUserConnectionResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["UserConnection"] = IResolversParentTypes["UserConnection"],
> = ResolversObject<{
...
export type IVercelApiPaginationResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["VercelApiPagination"] = IResolversParentTypes["VercelApiPagination"],
> = ResolversObject<{
...
export type IVercelApiProjectResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["VercelApiProject"] = IResolversParentTypes["VercelApiProject"],
> = ResolversObject<{
  id?: Resolver<IResolversTypes["ID"], ParentType, ContextType>;
  link?: Resolver<
    Maybe<IResolversTypes["VercelApiProjectLink"]>,
    ParentType,
    ContextType
  >;
  linkedProject?: Resolver<
    Maybe<IResolversTypes["Project"]>,
    ParentType,
    ContextType
  >;
  ...
  >;
  status?: Resolver<
    IResolversTypes["VercelApiProjectStatus"],
    ParentType,
    ContextType,
    RequireFields<IVercelApiProjectStatusArgs, "accountId">
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type IVercelApiProjectConnectionResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["VercelApiProjectConnection"] = IResolversParentTypes["VercelApiProjectConnection"],
> = ResolversObject<{
  pagination?: Resolver<
    IResolversTypes["VercelApiPagination"],
    ParentType,
    ContextType
  >;
  projects?: Resolver<
    Array<IResolversTypes["VercelApiProject"]>,
    ParentType,
    ContextType
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type IVercelApiProjectLinkResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["VercelApiProjectLink"] = IResolversParentTypes["VercelApiProjectLink"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    "VercelApiProjectLinkGithub" | "VercelApiProjectLinkOther",
    ParentType,
    ContextType
  >;
...
export type IVercelApiProjectLinkGithubResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["VercelApiProjectLinkGithub"] = IResolversParentTypes["VercelApiProjectLinkGithub"],
> = ResolversObject<{
...
export type IVercelApiProjectLinkOtherResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["VercelApiProjectLinkOther"] = IResolversParentTypes["VercelApiProjectLinkOther"],
> = ResolversObject<{
  type?: Resolver<IResolversTypes["String"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type IVercelApiTeamResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["VercelApiTeam"] = IResolversParentTypes["VercelApiTeam"],
> = ResolversObject<{
  id?: Resolver<IResolversTypes["ID"], ParentType, ContextType>;
  name?: Resolver<IResolversTypes["String"], ParentType, ContextType>;
  slug?: Resolver<IResolversTypes["String"], ParentType, ContextType>;
...
export type IVercelApiTokenResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["VercelApiToken"] = IResolversParentTypes["VercelApiToken"],
> = ResolversObject<{
  access_token?: Resolver<IResolversTypes["String"], ParentType, ContextType>;
  installation_id?: Resolver<
    IResolversTypes["String"],
    ParentType,
    ContextType
  >;
...
export type IVercelConfigurationResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["VercelConfiguration"] = IResolversParentTypes["VercelConfiguration"],
> = ResolversObject<{
  apiProjects?: Resolver<
    Maybe<IResolversTypes["VercelApiProjectConnection"]>,
    ParentType,
    ContextType
  >;
  id?: Resolver<IResolversTypes["ID"], ParentType, ContextType>;
...
export type IVercelProjectResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["VercelProject"] = IResolversParentTypes["VercelProject"],
> = ResolversObject<{
  configuration?: Resolver<
    IResolversTypes["VercelConfiguration"],
    ParentType,
    ContextType
  >;
  id?: Resolver<IResolversTypes["ID"], ParentType, ContextType>;
...
export type IDailyCountResolvers<
  ContextType = Context,
  ParentType extends
    IResolversParentTypes["dailyCount"] = IResolversParentTypes["dailyCount"],
> = ResolversObject<{
  count?: Resolver<IResolversTypes["Int"], ParentType, ContextType>;
