...
buildAndSynchronize: TRACE_SERVICE_NAME=buildAndSynchronize CONSUME_AND_RESTART=1 ./src/scripts/heroku-node-settings.sh lib/server/workers/buildAndSynchronize.js
