            ...
            output: {
              ...
              data: {
                ...
                user: {
                  ...
                  relatedRepositories: state.fetch.output.data.user.relatedRepositories.reduce((all, repository) => [
                    ...all,
                ...
                user: {
                  ...
                  relatedRepositories: state.fetch.output.data.user.relatedRepositories.reduce((all, repository) => [
                    ...
                    repository.id === action.payload.output.data.toggleRepository.id ?
                      { ...repository, enabled: action.payload.output.data.toggleRepository.enabled } :
                      repository,
                  ], []),
                },
              },
